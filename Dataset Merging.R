...
data_us_2018_sample <- data.table(head(data_us_2018, 5000))
...
data_us_2019_sample <- data.table(head(data_us_2019, 5000))
...
data_us_2020_sample <- data.table(head(data_us_2020, 5000))
